...
// Extend the Window interface for the shutter flag used elsewhere on the page
declare global {
  interface Window {
...
export default function HeroTextAnimation() {
  ...
  // Monitor when the component is in view
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      if (window.__shutterComplete) {
        const handleSSF = () => setShutterFinished(true);
        handleSSF();
      }
    }
